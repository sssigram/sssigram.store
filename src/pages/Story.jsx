        ...
        <BodyContainer>
          <div className='flex flex-col gap-1.5 items-center my-6'>
            ...
            <p className='text-lg text-center'>
              ...
              solution for individuals who want to save stories from Instagram.
              Whether you wish to repost, re-upload or simply save them for
              future viewing with your friends, this app allows you to add
              stories to your own media library without any restrictions. Enjoy
              the freedom to download and save as many Instagram stories as you
              desire!
            </p>
          </div>
