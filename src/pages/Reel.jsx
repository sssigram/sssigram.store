  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='description'
          content='Welcome to the Reel Page'
        />
        <meta
          name='keywords'
          ...
          <BodyContainer>
            <div className='flex flex-col gap-1.5 items-center my-6'>
              ...
              <p className='text-lg text-center'>
                ...
                friends, this app allows you to add Reels videos to your own
                media library without any restrictions. Enjoy the freedom to
                download and save as many Instagram Reels videos as you desire!
              </p>
            </div>
            ...
            <div>
              ...
              <p className='text-lg text-center'>
                Downloading an Instagram Reels video is a simple process that
                can be done in just three easy steps:
              </p>
            </div>
