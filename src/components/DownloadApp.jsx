...
const DownloadApp = () => {
  return (
    <div className='w-full p-4 bg-gradient-to-br from-[#e7c9c9] via-[#cfc3e0] to-[#d2dbed] rounded-xl shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700 flex flex-col md:flex-row justify-between items-center dark:text-gray-200'>
      <div className='w-full text-center md:text-start mb-4'>
        ...
        <p className='mb-2 text-base text-gray-700 sm:text-md dark:text-gray-400'>
          Download ...... app from Google Play or App store for unlimited fast
          and easy downloads with no watermark and HD quality.
        </p>
      </div>

      <div className='items-center md:items-end justify-center space-y-2 sm:flex md:flex-col lg:flex-row lg:gap-0 md:gap-4 sm:space-y-0 sm:space-x-4 rtl:space-x-reverse w-full'>
        <Link
          to={"#"}
